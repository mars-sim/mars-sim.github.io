...
<span class="badge text-bg-primary">Version: 4.0</span>
Screenshots from Mars Simulation Project.

Overview of the application showing the Event Viewer, a Person, Monitor Tool and Settlement Map.
...
The various attributes of the simulated entities are shown in targeted tab panels. Below shows the Entity Browser as well.
